...
def graph_select_border(xmin=0, xmax=0, ymin=0, ymax=0, deselect=False, extend=True):
    pass
...
def select_border(xmin=0, xmax=0, ymin=0, ymax=0, deselect=False, extend=True):
    pass
