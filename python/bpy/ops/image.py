...
def new(name="Untitled", width=1024, height=1024, color=(0.0, 0.0, 0.0, 1.0), alpha=True, generated_type='BLANK', float=False, use_stereo_3d=False):
    pass
...
def view_zoom_border(xmin=0, xmax=0, ymin=0, ymax=0, zoom_out=False):
    pass
