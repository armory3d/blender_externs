...
def select_border(xmin=0, xmax=0, ymin=0, ymax=0, deselect=False, extend=True, tweak=False):
    pass


def select_circle(x=0, y=0, radius=25, deselect=False):
    pass
...
def viewer_border(xmin=0, xmax=0, ymin=0, ymax=0, deselect=False, extend=True):
    pass
