...
def interaction_preset_add(name="", remove_name=False, remove_active=False):
    pass
...
def previews_clear(id_type={'GROUP', 'IMAGE', 'LIGHT', 'MATERIAL', 'OBJECT', 'SCENE', 'TEXTURE', 'WORLD'}):
    pass
...
def properties_edit(data_path="", property="", value="", min=-10000, max=10000.0, use_soft_limits=False, is_overridable_static=False, soft_min=-10000, soft_max=10000.0, description=""):
    pass
...
def studiolight_install(files=None, directory="", filter_folder=True, filter_glob="*.png;*.jpg;*.hdr;*.exr", orientation='MATCAP'):
    pass
