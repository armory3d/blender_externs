class UILayout:
    ...
    def operator(self, operator, text="", text_ctxt="", translate=True, icon='NONE', emboss=True, depress=False, icon_value=0):
        pass

    def operator_menu_hold(self, operator, text="", text_ctxt="", translate=True, icon='NONE', emboss=True, depress=False, icon_value=0, menu):
        pass
    ...
    def popover(self, panel, text="", text_ctxt="", translate=True, icon='NONE', icon_value=0):
        pass
    ...
    def template_ID(self, data, property, new="", open="", unlink="", filter='ALL', live_icon=False):
        pass

    def template_ID_preview(self, data, property, new="", open="", unlink="", rows=0, cols=0, filter='ALL'):
        pass

    def template_any_ID(self, data, property, type_property, text="", text_ctxt="", translate=True):
        pass

    def template_ID_tabs(self, data, property, new="", open="", menu="", filter='ALL'):
        pass
