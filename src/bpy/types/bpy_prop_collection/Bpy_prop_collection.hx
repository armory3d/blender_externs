...
@:pythonImport("bpy.types.bpy_prop_collection", "bpy_prop_collection") extern class Bpy_prop_collection {
	...
	**/
	...
	public function foreach_get(attr:Dynamic, seq:Dynamic):Dynamic;
	public function foreach_set(attr:Dynamic, seq:Dynamic):Dynamic;
