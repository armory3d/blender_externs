...
@:pythonImport("mathutils", "Quaternion") extern class Quaternion {
	...
	**/
	...
	public function slerp(other:Dynamic, factor:Dynamic):Dynamic;
	public function to_axis_angle():Dynamic;
	public function to_euler(order:Dynamic, euler_compat:Dynamic):Dynamic;
	public function to_exponential_map():Dynamic;
	public function to_matrix():Dynamic;
